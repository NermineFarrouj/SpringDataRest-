package net.supervision.appresttemplate.services;
...
public class ServiceEtudiant {
    ...
    private final String BASE_URL = "http://localhost:8080/students";
    private static final String BASE_URL2 = "http://localhost:8080/students/search/findEtudiantByNom?nom={nom}";
